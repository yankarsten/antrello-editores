-- The "Novo" board column was removed; fold any project still in that state
-- into "Em edição" so it stays visible on the board.
UPDATE "Project" SET "status" = 'em_edicao' WHERE "status" = 'novo';
